...
public class ServiceControllerRemoveServiceTest extends RmmServicesServerAppApplicationTests{
	...
	public void setup() throws Exception {
		...
		ResponseEntity<Object> entity = restTemplate.exchange(
        		"http://localhost:" + port + "/customers/6/services/1", 
        		HttpMethod.POST, 
        		request, 
        		Object.class);
	}
	...
	public void removeServiceOK() {
		...
		assertTrue(servicesNumber>0);
		
        ResponseEntity<Object> entity = restTemplate.exchange(
        		"http://localhost:" + port + "/customers/6/services/2", 
        		HttpMethod.POST, 
        		request, 
        		Object.class);
	...
	@Test
	public void removeServiceNotAdded() {
		HttpHeaders headers = new HttpHeaders();
		headers.setContentType(MediaType.APPLICATION_JSON);
		headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
		headers.add("Authorization", JwtAuthorizationFilter.PREFIX + token.getToken());
		...
		ResponseEntity<Object> entity = restTemplate.exchange(
        		"http://localhost:" + port + "/customers/6/services/3", 
        		HttpMethod.DELETE, 
        		request, 
        		Object.class);
	...
	@Test
	public void removeServiceNotFound() {
		HttpHeaders headers = new HttpHeaders();
		headers.setContentType(MediaType.APPLICATION_JSON);
		headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
        ...
        ResponseEntity<Object> entity = restTemplate.exchange(
        		"http://localhost:" + port + "/customers/6/services/10020304", 
        		HttpMethod.DELETE, 
        		request, 
        		Object.class);
        assertEquals(404, entity.getStatusCodeValue());
	...
	@Test
	public void removeServiceWrongCustomer() {
		HttpHeaders headers = new HttpHeaders();
		headers.setContentType(MediaType.APPLICATION_JSON);
		headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
		headers.add("Authorization", "Bearer " + token.getToken());
	...
	@Test
	public void removeServiceNoAuthorizationHeader() {
		HttpHeaders headers = new HttpHeaders();
		headers.setContentType(MediaType.APPLICATION_JSON);
		headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
	...
	@Test
	public void removeServiceWrongAuthorizationHeader() {
		HttpHeaders headers = new HttpHeaders();
		headers.setContentType(MediaType.APPLICATION_JSON);
		headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
	...
	private int getServicesNumber() {
        ...
        ResponseEntity<Service[]> entity = restTemplate.exchange(
        		"http://localhost:" + port + "/customers/6/services", 
        		HttpMethod.GET, 
        		request, 
        		Service[].class);
